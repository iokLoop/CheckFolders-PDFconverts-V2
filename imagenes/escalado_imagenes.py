...
os.chmod(current_dir + "/peq", 0o755) # LE DAMOS PERMISO DE ESCRITURA
tamano = int(input("Tamaño: ")) # PREGUNTAMOS EL TAMAÑO PARA LAS NUEVAS FOTOS 
comprimir = input("¿Desea comprimir las fotos? (si/no): ").lower()
